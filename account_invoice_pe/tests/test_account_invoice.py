...
class AccountInvoiceTestCase(ModuleTestCase):
    ...
    @with_transaction()
    def test_debug_conf(self):
        'Test Ebilling document write'
        
        Invoice = Pool().get('account.invoice')
        config_debug = 'development'
        actual_debug = 'production'
        self.assertRaises(UserWarning, Invoice.compare_debug, config_debug, actual_debug)
